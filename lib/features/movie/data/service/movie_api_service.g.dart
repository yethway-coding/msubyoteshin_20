...
class _MovieApiService implements MovieApiService {
  ...
  Future<MovieResponseModel> getMovies({int page = 1}) async {
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/movie?page=${page}&limit=20&sort=desc',
  ...
  @override
  Future<MovieDetailResponseModel> getMovieDetail({required String id}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  Future<MovieResponseModel> getMovieByActor({
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/movie?page=${page}&limit=20&sort=desc&actor=${actorId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<MovieResponseModel> getMovieByGenre({
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/movie?page=${page}&limit=20&sort=desc&genre=${genreId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<MovieResponseModel> getMovieBySearch({
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/movie?page=${page}&limit=20&sort=desc&search=${keyword}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
